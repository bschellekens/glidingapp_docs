...
| **Excluded Groups** | User groups that must be excluded from this duty | students |
| **Autofill method** | How assignments are made | Empty (manual), Auto (automatic), Social (preferences) |
| **Days between** | Minimum rest period between same duty assignments | 10 days |
...
3. Member's within the limited groups can now add their preference
